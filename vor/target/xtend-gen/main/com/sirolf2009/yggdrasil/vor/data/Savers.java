  ...
  public static class StringToFile implements Consumer<String> {
    ...
    public void accept(final String t) {
      try {
        ...
        String _humanReadableByteCount = Savers.StringToFile.humanReadableByteCount(t.getBytes().length, false);
        _builder.append(_humanReadableByteCount);
        _builder.append(" bytes to ");
        _builder.append(this.file);
        Savers.StringToFile.log.info(_builder);
    ...
    public boolean equals(final Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      Savers.StringToFile other = (Savers.StringToFile) obj;
      if (this.file == null) {
        if (other.file != null)
          return false;
  ...
  public static class NetToFile implements Consumer<MultiLayerNetwork> {
    ...
    public void accept(final MultiLayerNetwork net) {
      try {
        ...
        _builder.append(this.file);
        Savers.NetToFile.log.info(_builder);
    ...
    public boolean equals(final Object obj) {
      ...
      if (getClass() != obj.getClass())
        return false;
      Savers.NetToFile other = (Savers.NetToFile) obj;
      if (this.file == null) {
        if (other.file != null)
          return false;
      } else if (!this.file.equals(other.file))
