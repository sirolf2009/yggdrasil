...
public class PrepareData {
  ...
  public DataFormat call() throws Exception {
    ...
    final INDArray trainingArray = PrepareData.createIndArrayFromStringList(this.data, this.numOfVariables, 0, this.trainSize);
    final INDArray testingArray = PrepareData.createIndArrayFromStringList(this.data, this.numOfVariables, this.trainSize, this.numberOfTimesteps);
    return new DataFormat(this.trainSize, this.numberOfTimesteps, this.numberOfTimesteps, this.numOfVariables, this.miniBatchSize, trainingArray, testingArray, this.baseDir, this.featuresDirTrain, this.labelsDirTrain, this.featuresDirTest, this.labelsDirTest);
  }
